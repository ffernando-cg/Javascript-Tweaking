...
function init() {
  ...
  //init function also initializes the typewritter effect found in section 3
  //la funcion init tambien inicializa el efecto de maquina tecleadora encontrado en la seccion 3
  //https://safi.me.uk/typewriterjs/
  $('.carousel').carousel({
    interval: 9999999999999
  })

  var textTyping = document.getElementById('textTyping');

  var typewriter = new Typewriter(textTyping, {
      loop: true
  });

  typewriter.typeString('www.konstudio.mx')
      .pauseFor(4000)
      .callFunction(() => $('.carousel').carousel(1), typewriter)
      .deleteAll()
      .typeString('www.yamamotodental.com.mx')
      .pauseFor(4000)
      .deleteAll()
      .callFunction(() => $('.carousel').carousel(2), typewriter)
      .typeString('www.thesingletonsaz.org')
      .pauseFor(4000)
